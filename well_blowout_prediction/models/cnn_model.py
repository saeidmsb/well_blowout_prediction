...
class CNNModel(nn.Module):
    def __init__(self, input_channels, num_classes=1):
        ...
        self.fc1 = nn.Linear(64 * 30, num_classes)  # 64 filters and 30 is the resulting feature map size after pooling
        self.relu = nn.ReLU()
...
# بارگذاری داده‌ها و پیش‌پردازش آن‌ها برای CNN
...
if __name__ == "__main__":
    input_file = './data/processed/processed_data_with_features.csv'  # داده‌های پردازش شده و مهندسی ویژگی
    model_output_file = './models/cnn_model.pth'  # مسیر ذخیره مدل CNN
